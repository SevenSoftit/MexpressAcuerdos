...
using Sevensoft.Mexpress.Backend.DataAccess.Repository;
namespace Sevensoft.Mexpress.Backend.BusinessLogic
{
    public class Ac_Cat_Agreement_Goals : IBusinessLogic
    {
        #region Region [Methods]
        /// <summary>
        /// Nombre: DoWork
        /// Descripcion: Metodo encargado de orquestar las solicitudes de operaciones para el objeto "AC_CAT_AGREEMENT_GOALS".
        /// Fecha de creación: 8/6/2019.
        /// Autor: dpacheco.
        /// </summary>
