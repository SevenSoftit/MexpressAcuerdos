    ...
    public class Ac_Mtr_Agreement_Date : IBusinessLogic
    {
        ...
        public async virtual Task<Message> List(Message message)
        {
            try
            {
                ...
                using (var repository = new Ac_Mtr_Agreement_Date_Repository(message.Connection))
                {
