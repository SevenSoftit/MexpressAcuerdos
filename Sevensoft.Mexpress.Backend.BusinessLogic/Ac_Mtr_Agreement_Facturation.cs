...
{
    public class Ac_Mtr_Agreement_Facturation : IBusinessLogic
    {
        #region Region [Methods]
        /// <summary>
        /// Nombre: DoWork
        /// Descripcion: Metodo encargado de orquestar las solicitudes de operaciones para el objeto.
        ...
        public async virtual Task<Message> List(Message message)
        {
            try
            {
                ...
                using (var repository = new Do_Mtr_Agreement_Facturation_Repository(message.Connection))
                {
