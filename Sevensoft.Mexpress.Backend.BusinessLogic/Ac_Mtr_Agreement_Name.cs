    ...
    public class Ac_Mtr_Agreement_Name : IBusinessLogic
    {
        ...
        public async virtual Task<Message> List(Message message)
        {
            try
            {
                ...
                using (var repository = new Ac_Mtr_Agreement_Name_Repository(message.Connection))
                {
