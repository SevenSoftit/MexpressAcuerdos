...
{
    public class Ac_Mtr_Provider : IBusinessLogic
    {
        #region Region [Methods]
        /// <summary>
        /// Nombre: DoWork
        /// Descripcion: Metodo encargado de orquestar las solicitudes de operaciones para el objeto "Ac_Mtr_Provider".
        ...
        public async virtual Task<Message> List(Message message)
        {
            ...
            {
                var resultMessage = new Message();
                var model = message.DeSerializeObject<Sevensoft.Mexpress.Backend.Common.Ac_Mtr_Provider>();
                using (var repository = new Ac_Mtr_Provider_Repository(message.Connection))
                {
