...
{
    public class Ac_Mtr_Type_Of_Agreement : IBusinessLogic
    {
        #region Region [Methods]
        /// <summary>
        /// Nombre: DoWork
        /// Descripcion: Metodo encargado de orquestar las solicitudes de operaciones para el objeto "Ac_Mtr_Type_Of_Agreement".
        ...
        public async virtual Task<Message> List(Message message)
        {
            ...
            {
                var resultMessage = new Message();
                var model = message.DeSerializeObject<Sevensoft.Mexpress.Backend.Common.Ac_Mtr_Type_Of_Agreement>();
                using (var repository = new Ac_Mtr_Type_Of_Agreement_Repository(message.Connection))
                {
