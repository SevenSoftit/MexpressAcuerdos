...
{
    public class Do_Mtr_Dashboard_Resume : IBusinessLogic
    {
        #region Region [Methods]
        /// <summary>
        /// Nombre: DoWork
        /// Descripcion: Metodo encargado de orquestar las solicitudes de operaciones para el objeto "Do_Mtr_Dashboard_Resume".
        ...
        public async virtual Task<Message> List(Message message)
        {
            ...
            {
                var resultMessage = new Message();
                var model = message.DeSerializeObject<Sevensoft.Mexpress.Backend.Common.Do_Mtr_Dashboard_Resume>();
                using (var repository = new Do_Mtr_Dashboard_Resume_Repository(message.Connection))
                {
