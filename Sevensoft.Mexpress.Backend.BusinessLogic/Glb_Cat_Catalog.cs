...
{
    public class Glb_Cat_Catalog : IBusinessLogic
    {
        #region Region [Methods]
        /// <summary>
        /// Nombre: DoWork
        /// Descripcion: Metodo encargado de orquestar las solicitudes de operaciones para el objeto "GLB_CAT_CATALOG".
        /// Fecha de creación: 10/05/2019.
        /// Autor: Gustavo ZC
        /// </summary>
        ...
        public async virtual Task<Message> List(Message message)
        {
            ...
            {
                var resultMessage = new Message();
                var model = message.DeSerializeObject<Sevensoft.Mexpress.Backend.Common.Glb_Cat_Catalog>();
                using (var repository = new Glb_Cat_Catalog_Repository(message.Connection))
                {
