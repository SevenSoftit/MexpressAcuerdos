...
namespace Sevensoft.Mexpress.Backend
{
    ...
    public class Ac_Mtr_Agreement_Date_Repository : IRepository<Common.Import_Product>, IDisposable
    {
        ...
        public Ac_Mtr_Agreement_Date_Repository(string connectionString)
        {
        ...
        public async Task<IEnumerable<Import_Product>> List(Import_Product model)
        {
            using (var connection = new SqlConnection(ConnectionString))
            {
                ...
                var result = connection.Query<
                    ...
                    ("PA_CON_AC_MTR_DATE_AGREEMENT_GET",
                    param: new
                    {
        ...
        ~Ac_Mtr_Agreement_Date_Repository()
        {
            Dispose(false);
        }
