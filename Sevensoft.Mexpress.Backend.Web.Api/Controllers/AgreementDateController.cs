...

{
    ...
    public class AgreementDateController : Controller
    {
        private IConfiguration configuration;
        public AgreementDateController(IConfiguration iConfiguration)
        {
        ...
        public async Task<IActionResult> List([FromBody] Common.Import_Product model)
        {
            try
            {
                ...
                message.BusinessLogic = configuration.GetValue<string>("AppSettings:BusinessLogic:Ac_Mtr_Agreement_Date");
        ...
        public async Task<IActionResult> Get([FromBody] Common.Import_Product model)
        {
            ...
            {
                var message = new Message();
                message.BusinessLogic = System.Configuration.ConfigurationManager.AppSettings["BusinessLogic:Ac_Mtr_Agreement_Date"];
