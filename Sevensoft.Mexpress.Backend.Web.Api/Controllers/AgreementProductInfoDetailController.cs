...
namespace Sevensoft.Mexpress.Backend.Web.Api.Controllers
{
    ...
    public class AgreementProductInfoDetailController : Controller
    {
        private IConfiguration configuration;
        public AgreementProductInfoDetailController(IConfiguration iConfiguration)
        {
            configuration = iConfiguration;
        }
        #region Region [Methods]
        /// <summary>
        /// Nombre: Listar Ac_Mtr_Agreement_Product_Info_Detail
        /// Descripcion: Metodo utilizado para obtener una lista de productos y retornar un objeto datatable
        /// Fecha de creacion: 13/08/2019
        /// Autor: Gustavo ZC
        /// </summary>
        ...
        /// <summary>
        /// Nombre: Obtener Ac_Mtr_Agreement_Product_Info_Detail
        /// Descripcion: Metodo utilizado para obtener una lista de productos y retornar un objeto datatable
        /// Fecha de creacion: 13/08/2019
        /// Autor: Gustavo ZC
        /// </summary>
        ...
        [Route("Get")]
        [HttpPost]
        public async Task<IActionResult> Get([FromBody] Common.Ac_Mtr_Agreement_Product_Info_Detail model)
        {
            try
            {
                var message = new Message();
        ...
        /// <summary>
        /// Nombre: Guardar Ac_Mtr_Agreement_Product_Info_Detail
        /// Descripcion: Metodo utilizado para guardar un objeto de tipo Ac_Mtr_Agreement_Product_Info_Detail.
        /// Fecha de creacion: 13/08/2019
        /// Autor: Gustavo ZC
        /// </summary>
        /// <param name="message"></param>
        ...
        /// <summary>
        /// Nombre: Eliminar Ac_Mtr_Agreement_Product_Info_Detail
        /// Descripcion: Metodo utilizado para eliminar un objeto de tipo Ac_Mtr_Agreement_Product_Info_Detail.
        /// Fecha de creacion: 13/08/2019
        /// Autor: Gustavo ZC
        /// </summary>
        /// <param name="message"></param>
        ...
        [Route("Delete")]
        [HttpPost]
        public async Task<IActionResult> Delete([FromBody] Common.Ac_Mtr_Agreement_Product_Info_Detail model)
        {
            try
            {
                ...
                using (var businessLgic = new ServiceManager())
                {
                    ...
                    var resultModel = result.DeSerializeObject<IEnumerable<Common.Ac_Mtr_Agreement_Product_Info_Detail>>();
                    // var dataSuccess = new
                    // {
                    //     Data = resultModel,
                    //     MessageResult = Backend.Common.Enum.Status.Success,
